...
function listChannel(cache) {
    ...
    global.displayName = guild.members.me.displayName
...
Please note that we do not take any responsibility for accounts being banned due to the use of our tools.`
    ...
    conf = resolveData(client.user.username, client.token, guildid, channelid, waynotify, musicpath, webhookurl, usernotify, autocaptcha, apiuser, apikey, prefix, autodaily, autopray, autoslash, autogem, autolootbox, gemorder, autoquote, autoother, autorefresh, autosleep, autowait)
